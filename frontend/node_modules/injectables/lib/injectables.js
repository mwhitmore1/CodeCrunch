...
Injectables.prototype.get = function(spec, name){
	...
	if(Array.isArray(spec)){
		...
		spec.forEach(function(s){
			...
			ret.push(self.get.apply(self, s));
		});
		return ret;
	}
...
/**
 * Determines if the injectables contains a dependency. The dependency  is specifed
 * by dependency identifier
 *
 * @param  {String} obj a string that identifies the dependency
 * @return {Boolean}     true if the injectables contains the specifed dependency
 */
